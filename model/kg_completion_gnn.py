...
class ComplExDecoder(nn.Module):
    ...
    def distance(head_embeds, relation_embeds, tail_embeds, p):
        ...
        h_Re, h_Im = head_embeds[:, :head_embeds.shape[1] / 2], head_embeds[:, head_embeds.shape[1] / 2:]
        t_Re, t_Im = tail_embeds[:, :tail_embeds.shape[1] / 2], tail_embeds[:, tail_embeds.shape[1] / 2:]
        r_Re, r_Im = relation_embeds[:, :relation_embeds.shape[1] / 2], relation_embeds[:, relation_embeds.shape[1]:]
